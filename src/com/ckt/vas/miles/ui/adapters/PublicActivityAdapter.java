        ...
        if (convertView == null || (holder = (ViewHolder) convertView.getTag()).flag != position) {
            ...
            if (position == 0) {
                ...
                if (ActivityMessage.MESSAGE_TYPE_TEXT == type) {
                    ...
                    View viewgcm = LayoutInflater.from(context).inflate(R.layout.feed_comments_item,
                            null);
                    TextView textgcm = (TextView) viewgcm.findViewById(R.id.comment_body);
                    textgcm.setText("mengxiangyisheng");
                    
                    
                    View view = LayoutInflater.from(context).inflate(
                            R.layout.moment_thought_partial, null);
                    
                    LinearLayout linearLayoutgcm = (LinearLayout) view.findViewById(R.id.feed_comments_thread);
                    linearLayoutgcm.addView(viewgcm);
                ...
                // Friend
                    ...
                    // count of commment
                    final TextView countcmt = (TextView) view.findViewById(R.id.comment_button_text);
                    countcmt.setText("5");
                    
                    RelativeLayout rl = (RelativeLayout)view.findViewById(R.id.comment_button);
                    rl.setOnClickListener(new OnClickListener(){

						@Override
						public void onClick(View v) {
							// TODO Auto-generated method stub
							Toast.makeText(context, "评论", 2000).show();
							 countcmt.setText("6");
							 
							 View viewgcm = LayoutInflater.from(context).inflate(R.layout.feed_comments_item,
			                            null);
			                    TextView textgcm = (TextView) viewgcm.findViewById(R.id.comment_body);
			                    textgcm.setText("pinglunyouxiao");
			                    LinearLayout linearLayoutgcm = (LinearLayout) view.findViewById(R.id.feed_comments_thread);
			                    linearLayoutgcm.addView(viewgcm);
